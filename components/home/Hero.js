  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex">
        <ScrollAnimationWrapper
          className="rounded-lg w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-9 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-300 bg-white-500 z-10">
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto">
                <div className="flex items-center justify-center w-12 h-12 mr-6 rounded-full">
                  <Image src={listUsers.icon} className="h-6 w-6" alt={listUsers.name} height={20} width={20}/>
                </div>
                <div className="flex flex-col">
                  <p className="text-xl text-black-600 font-bold: dark:text-white">
                    {listUsers.number}+
                  </p>
                  <p className="text-lg text-black-500 dark:text-white">{listUsers.name}</p>
                </div>
              </div>
            </motion.div>
          ))}
